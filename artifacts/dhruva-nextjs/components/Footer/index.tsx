      ...
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mb-10 mt-5">
                  Your pole star for technology transformation. We guide enterprises through complex technical challenges.
                </p>
                ...
                <a
                  href="mailto:admin@dhruvatechnologies.com"
                  className="text-itemtitle font-medium text-black dark:text-white"
                >
                  admin@dhruvatechnologies.com
                </a>
              </motion.div>
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                >
                  ...
                  <ul>
                    <li>
                      <span className="mb-3 inline-block text-black dark:text-white">
                        26, Balaji Nagar, New Sidhapudur, Coimbatore, Tamil Nadu 641035
                      </span>
                    </li>
                    <li>
                      <a
                        href="tel:+919945869977"
                        className="mb-3 inline-block hover:text-primary"
                      >
                        +91 9945869977
                      </a>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; 2025 Dhruva Technologies. All rights reserved.
              </p>
            </motion.div>
